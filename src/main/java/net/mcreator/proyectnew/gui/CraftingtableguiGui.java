...
public class CraftingtableguiGui extends ProyectNewModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public CraftingtableguiGui(ProyectNewModElements instance) {
		super(instance, 14);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 23, 14) {
			}));
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 42, 14) {
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 61, 14) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 23, 32) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 42, 32) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 61, 32) {
			}));
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 23, 51) {
			}));
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 42, 51) {
			}));
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 61, 51) {
			}));
			this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 110, 31) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				ProyectNewMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
