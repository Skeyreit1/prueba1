...
import net.mcreator.proyectnew.entity.KaorifujiwaravillagerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class KaorifujiwaravillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(KaorifujiwaravillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelkaorifujiwaravillager(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("proyect_new:textures/no1_5.png");
					}
				};
			});
		}
	...
	public static class Modelkaorifujiwaravillager extends EntityModel<Entity> {
		...
		public Modelkaorifujiwaravillager() {
			textureWidth = 64;
			textureHeight = 64;
