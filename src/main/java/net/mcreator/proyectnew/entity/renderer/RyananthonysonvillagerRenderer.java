...
import net.mcreator.proyectnew.entity.RyananthonysonvillagerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class RyananthonysonvillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RyananthonysonvillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelryananthonysonvillager(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("proyect_new:textures/f3f76512f50d130c.png");
					}
				};
			});
		}
	...
	public static class Modelryananthonysonvillager extends EntityModel<Entity> {
		...
		public Modelryananthonysonvillager() {
			textureWidth = 64;
			textureHeight = 64;
