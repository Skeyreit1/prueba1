...
import net.mcreator.proyectnew.entity.ManoloMitchellvillagerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ManoloMitchellvillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ManoloMitchellvillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelManoloMitchellvillager(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("proyect_new:textures/38a000facdc4ec72.png");
					}
				};
			});
		}
	...
	public static class ModelManoloMitchellvillager extends EntityModel<Entity> {
		...
		public ModelManoloMitchellvillager() {
			textureWidth = 64;
			textureHeight = 64;
