...
import net.mcreator.proyectnew.entity.TeddieWallervillagerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class TeddieWallervillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TeddieWallervillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelTeddieWallervillager(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("proyect_new:textures/ca5ee10cbf08804a.png");
					}
				};
			});
		}
	...
	public static class ModelTeddieWallervillager extends EntityModel<Entity> {
		...
		public ModelTeddieWallervillager() {
			textureWidth = 64;
			textureHeight = 64;
