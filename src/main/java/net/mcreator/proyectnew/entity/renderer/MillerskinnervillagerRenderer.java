...
import net.mcreator.proyectnew.entity.MillerskinnervillagerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class MillerskinnervillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MillerskinnervillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelMilesskinnervillager(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("proyect_new:textures/3d28aeae6facb1f5.png");
					}
				};
			});
		}
	...
	public static class ModelMilesskinnervillager extends EntityModel<Entity> {
		...
		public ModelMilesskinnervillager() {
			textureWidth = 64;
			textureHeight = 64;
