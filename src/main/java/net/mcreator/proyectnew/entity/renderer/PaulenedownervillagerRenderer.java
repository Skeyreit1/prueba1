...
import net.mcreator.proyectnew.entity.PaulenedownervillagerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class PaulenedownervillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PaulenedownervillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpaulenedownervillager(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("proyect_new:textures/2022_04_14_--grape-uiro---20191064.png");
					}
				};
			});
		}
	...
	public static class Modelpaulenedownervillager extends EntityModel<Entity> {
		...
		public Modelpaulenedownervillager() {
			textureWidth = 64;
			textureHeight = 64;
