...
import net.mcreator.proyectnew.entity.NoburumizutanivillagerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class NoburumizutanivillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NoburumizutanivillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelnoburumizutanivillager(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("proyect_new:textures/b37879edd0989421.png");
					}
				};
			});
		}
	...
	public static class Modelnoburumizutanivillager extends EntityModel<Entity> {
		...
		public Modelnoburumizutanivillager() {
			textureWidth = 64;
			textureHeight = 64;
