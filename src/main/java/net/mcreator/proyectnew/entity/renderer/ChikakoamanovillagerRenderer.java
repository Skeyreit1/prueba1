...
import net.mcreator.proyectnew.entity.ChikakoamanovillagerEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ChikakoamanovillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ChikakoamanovillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelchikakoamanovillager(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("proyect_new:textures/no1_1.png");
					}
				};
			});
		}
	...
	public static class Modelchikakoamanovillager extends EntityModel<Entity> {
		...
		public Modelchikakoamanovillager() {
			textureWidth = 64;
			textureHeight = 64;
